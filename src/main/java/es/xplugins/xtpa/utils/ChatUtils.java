...
public class ChatUtils {
    ...
    public static void sendMessage(Player player, String message, boolean center) {

        if (message == null) return;

        if (message.isEmpty() || ChatColor.stripColor(colorize(message)).trim().isEmpty()) {
    ...
    public enum DefaultFontInfo {
        ...
        PLUS_SIGN('+', 5), EQUALS_SIGN('=', 5), LEFT_CURLY_BRACE('{', 4), RIGHT_CURLY_BRACE('}', 4),
